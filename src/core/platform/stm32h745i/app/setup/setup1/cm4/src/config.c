...
void UART_Config(void)
{
  ...
  // Don't deinit - CM7 already configured the hardware
  ...
  // BSP_LED_Off(LED_RED);  // Signal success
}
...
void MX_ADC1_Init(void)
{
  ...
  */
  ...
  HAL_StatusTypeDef rc = HAL_ADC_Init(&hadc1);
  if (rc != HAL_OK)
  {
    Error_Handler();
  }
  ...
  */
  ...
  rc = HAL_ADCEx_MultiModeConfigChannel(&hadc1, &multimode);
  if (rc != HAL_OK)
  {
    Error_Handler();
  }
...
void MX_SAI2_Init(void)
{
  ...
  hsai_BlockA2.Init.NoDivider = SAI_MCK_OVERSAMPLING_ENABLE;
...
void MX_GPIO_Init(void)
{
 GPIO_InitTypeDef GPIO_InitStruct = {0};
  ...
  HAL_GPIO_WritePin(GPIOB, Digital_Output_4_Pin|Digital_Output_15_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(Digital_Output_3_GPIO_Port, Digital_Output_3_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOI, Digital_Output_2_Pin|Digital_Output_8_Pin|Digital_Output_11_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : Digital_Output_4_Pin Digital_Output_15_Pin */
  GPIO_InitStruct.Pin = Digital_Output_4_Pin|Digital_Output_15_Pin;
  ...
  /*Configure GPIO pin : Digital_Output_3_Pin */
  GPIO_InitStruct.Pin = Digital_Output_3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(Digital_Output_3_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : Digital_Output_2_Pin Digital_Output_8_Pin Digital_Output_11_Pin */
  GPIO_InitStruct.Pin = Digital_Output_2_Pin|Digital_Output_8_Pin|Digital_Output_11_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
