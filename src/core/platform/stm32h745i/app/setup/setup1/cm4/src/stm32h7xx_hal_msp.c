/**
  ******************************************************************************
  * @file    FatFs/FatFs_Shared_Device/CM4/Src/stm32h7xx_hal_msp.c
...
{
  // I think this was removed to fix something at some point, but I'm putting it here
  // for now as it's what CubeMX generated.
...
void HAL_UART_MspInit(UART_HandleTypeDef *huart)
{
  ...
  RCC_PeriphClkInit.PeriphClockSelection = USARTx_PERIPHCLK;
  RCC_PeriphClkInit.Usart234578ClockSelection = USARTx_CLKSOURCE;
