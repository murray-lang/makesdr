...
template <typename RxPipelineSettingsType, typename TxPipelineSettingsType>
class BandSettings : public SettingsBase, public ResolveIndirection
{
public:
  ...
  RxPipelineSettingsType& pipelineASettings() { return m_pipelineA; }
  [[nodiscard]] const RxPipelineSettingsType& pipelineASettings() const { return m_pipelineA; }

  RxPipelineSettingsType& pipelineBSettings() { return m_pipelineB; }
  [[nodiscard]] const RxPipelineSettingsType& pipelineBSettings() const { return m_pipelineB; }

  TxPipelineSettingsType& txPipelineSettings() { return m_txPipeline; }
  [[nodiscard]] const TxPipelineSettingsType& txPipelineSettings() const { return m_txPipeline; }
  ...
  const RxPipelineSettingsType* getPipelineSettings(PipelineId pipelineId) const
  {
  ...
  const RxPipelineSettingsType* getFocusPipelineSettings() const
  {
...
protected:
  ...
  RxPipelineSettingsType m_pipelineA;
  RxPipelineSettingsType m_pipelineB;
  TxPipelineSettingsType m_txPipeline;
  // BandVector m_bands;
};
