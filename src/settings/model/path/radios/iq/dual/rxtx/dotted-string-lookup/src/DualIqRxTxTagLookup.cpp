...
const FieldEntry active_bands_fields[] = {
  {"focus_band", makesdr_RxTxDualIqActiveBandSettingsPb_focus_band_tag,  band_settings_fields},
  {nullptr, 0,  nullptr}
};

extern const FieldEntry dual_iq_rxtx_radio_fields[] = {
  {"active_bands", makesdr_DualIqRxTxSettingsPb_active_bands_tag,  active_bands_fields},
  {"receiver", makesdr_DualIqRxTxSettingsPb_receiver_tag,  receiver_fields},
  {"transmitter", makesdr_DualIqRxTxSettingsPb_transmitter_tag,  transmitter_fields},
  {"ptt", makesdr_DualIqRxTxSettingsPb_ptt_tag,  nullptr},
