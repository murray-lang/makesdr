...
#include "settings/model/message/MessageTraverser.h"
...
ResultCode
MessageTraverser::updateField(pb_field_iter_t* iter, const FieldUpdateVariant &value)
{
...
ResultCode
MessageTraverser::updateSteppable(pb_field_iter_t* msg_iter, const FieldUpdateVariant& steppableValue)
{
...
ResultCode
MessageTraverser::markFieldPresent(const pb_field_iter_t* iter)
{
...
ResultCode
MessageTraverser::mergePresentFields(const void* pRhsMessage)
{
...
bool
MessageTraverser::fieldHasMergeablePresence(const pb_field_iter_t* iter)
{
  if (iter == nullptr) {
    return false;
  }
...
bool
MessageTraverser::shouldVisitField(const pb_field_iter_t* iter)
{
  if (iter == nullptr) {
    return false;
  }
...
ResultCode
MessageTraverser::copyPresentField(pb_field_iter_t* pLhsIter, const pb_field_iter_t* pRhsIter)
{
...
ResultCode
MessageTraverser::mergePresentFields(
  void* pLhsMessage,
...
ResultCode
MessageTraverser::getField(pb_field_iter_t* iter, FieldUpdateVariant& value)
{
...
ResultCode
MessageTraverser::setFieldPresence(
  void* pMessage,
  const pb_msgdesc_t *pDescriptor,
  const FieldPath &path,
  bool present)
...
ResultCode
MessageTraverser::setAllFieldsPresence(
  void* pMessage,
  const pb_msgdesc_t *pDescriptor,
  bool present)
{
...
#ifdef USE_ETL
MessageTraverser::StringValue
MessageTraverser::StringValueVisitor::operator()(const NameString& value) const
{
  return {value.c_str(), static_cast<pb_size_t>(value.size())};
}

MessageTraverser::StringValue
MessageTraverser::StringValueVisitor::operator()(const LabelString& value) const
{
  return {value.c_str(), static_cast<pb_size_t>(value.size())};
}
#else
MessageTraverser::StringValue
MessageTraverser::StringValueVisitor::operator()(const std::string& value) const
{
  return {value.c_str(), static_cast<pb_size_t>(value.size())};
}
#endif
...
MessageTraverser::StringValue
MessageTraverser::getStringValue(const FieldUpdateVariant& value)
{
